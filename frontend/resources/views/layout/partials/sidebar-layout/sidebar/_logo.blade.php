...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<h1>
		<a href="{{ route('dashboard') }}" style="margin-left: 21px;">
			<!-- <img alt="Logo" src="{{asset('logo\logo.png')}}" class="h-40px app-sidebar-logo-default" /> -->
			<b class="text-white" style="margin-left: -11px;margin-top: 11px;position: absolute;">Robot Booking</b>
		</a>
	</h1>
	<!--end::Logo image-->
