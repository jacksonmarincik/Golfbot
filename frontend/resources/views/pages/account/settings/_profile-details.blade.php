...
<div class="card {{ $class }}">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        <!--begin::Form-->
        <form id="profile_details_form" class="form" method="" action="" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <!--begin::Image input-->
                        <div class="image-input image-input-outline {{ auth()->user()->image ? '' : 'image-input-empty' }}" data-kt-image-input="true" style="background-image: url({{ asset( 'avatars/blank.png') }})">
                            <!--begin::Preview existing avatar-->      
                            <div class="image-input-wrapper w-125px h-125px" style="background-image: <?php if(auth()->user()->image){?>url(' <?php echo auth()->user()->image;}else{ echo "none"; } ?>');"></div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col">
                                <input type="text" name="full_name" id="full_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="{{ old('full_name', auth()->user()->name ?? '') }}"/>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col">
                                <input type="email" name="email" id="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Email" value="{{ old('email', auth()->user()->email ?? '') }}"/>
                                <p class="error text-danger"></p>
                            </div>
                            <!--end::Col-->
                        </div>
            ...
            {{--
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="tel" name="phone" id="phone" class="form-control form-control-lg form-control-solid"  readonly
                        onkeypress="validatePhone(event)" placeholder="Phone number" value="{{ old('phone', auth()->user()->phone ?? '') }}"/>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
...
<script>
    $(document).ready(function() {
        $('#profile_details_form').on('submit', function(e) {
            e.preventDefault();
